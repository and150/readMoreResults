        ...
        for j in range(0,mw):                                      
            ...
            if IWVCMP == 1:                       
                ...
                for kk in range(0,mwzone): # итераци€ по сло€м модели
                   if compArr[kk] !=0:
                      ResArr[nrate*V*j + nrate*(V+compArr[kk]-1) + n] = farr[kk]  # записываем дебит нефти по перфораци€м                   
                      ResArr[nrate*V*j + nrate*(V +mwzone+compArr[kk]-1) + n] = farr[kk + 2*mwzone] # записываем дебит воды(приемистость) по перфораци€м
